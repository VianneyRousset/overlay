...
DESCRIPTION="realthunder's fork of FreeCAD"
HOMEPAGE="https://www.freecadweb.org/ https://github.com/realthunder/FreeCAD"

inherit git-r3
EGIT_REPO_URI="https://github.com/realthunder/FreeCAD.git"
S="${WORKDIR}/freecad-realthunder-${PV}"
...
src_install() {
	...
	if ! use headless; then
		...
		mv "${ED}"/usr/$(get_libdir)/${PN}/share/* "${ED}"/usr/share || die "failed to move shared ressources"
	fi
